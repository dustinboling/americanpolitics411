...
ActiveRecord::Schema.define(:version => 20121003183814) do
  ...
  add_index "organization_people", ["organization_id"], :name => "index_organization_people_on_organization_id"
